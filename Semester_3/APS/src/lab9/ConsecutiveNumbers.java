...
public class ConsecutiveNumbers {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BNode<Integer> prev;
        Integer leftMost;
        BNode<Integer> tmp = tree.head.left;
        ...
        leftMost = tmp.info;
        System.out.println(String.format("LEFTMOST %s", leftMost));
        prev = tmp;
        System.out.println(tmp.info);
        //System.out.println(tmp.right.info);
        boolean result = true;
        tmp = tmp.right;
        while (tmp != tree.head){
//            if(Objects.equals(tmp.info, leftMost)){
//                prev = tmp;
//                tmp = tmp.right;
//                continue;
//            }
            System.out.println(tmp.info);
            System.out.println(String.format("-----------------%d - %d = %d", tmp.info, prev.info, tmp.info-prev.info));
            if(tmp.info - prev.info != 1){
                result = false;
