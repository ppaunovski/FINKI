...
////
////    public String getProvision(){
////        return String.valueOf(Integer.parseInt(getAmount().substring(0, getAmount().length()-1)) * percent * 1.0 / 100) + "$";
////    }
////
...
////            //totalTransfer += (Integer.parseInt(t.getAmount().substring(0, t.getAmount().length()-1)) + Integer.parseInt(t.getProvision().substring(0, t.getProvision().length()-1)));
////            //totalProvision += (Integer.parseInt(t.getProvision().substring(0, t.getProvision().length()-1)));
////            //checkValidId(t.getFromId()).setBalance(String.valueOf(Integer.parseInt(checkValidId(t.getFromId()).getBalance().substring(0,checkValidId(t.getFromId()).getBalance().length()-1)) - (Integer.parseInt(t.getAmount().substring(0, t.getAmount().length()-1)) + Integer.parseInt(t.getProvision().substring(0, t.getProvision().length()-1)))) + "$");
...
////        return String.valueOf(totalTransfer) + "$";
////    }
////
...
////        if(senderAcc != null){
////            //return(Integer.parseInt(senderAcc.getBalance().substring(0, senderAcc.getBalance().length() -1 )) >= (Integer.parseInt(t.getAmount().substring(0, t.getAmount().length()-1)) + Integer.parseInt(t.getProvision().substring(0, t.getProvision().length()-1))));
////            return true;
////        }
////        return false;
////    }
