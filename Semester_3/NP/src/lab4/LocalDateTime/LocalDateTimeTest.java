...
public class LocalDateTimeTest {
    ...
    static LocalDateTime localTimeWith() {
        ...
        return LocalDateTime.of(LocalDate.from(ldt.toLocalDate().plusMonths(1).withDayOfMonth(1)),
        LocalTime.from(ldt.toLocalTime().truncatedTo(ChronoUnit.HOURS)));
    }
    ...
    static LocalDateTime localDatePlusMinus() {
         ...
         */
        return LocalDateTime.from(ldt.plus(Period.ofMonths(10)).minus(Duration.ofHours(5)));
    }
