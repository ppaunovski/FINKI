...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeOf() {
         ...
         */
        return ZonedDateTime.of(2015, 7, 10, 2, 14, 25, 0, ZoneId.of("JST", Map.of("JST", "Asia/Tokyo")));
    }
    ...
    static ZonedDateTime zonedDateTimeParse() {
         ...
         */
        return ZonedDateTime.parse("2015-06-20T23:07:30", DateTimeFormatter.ISO_DATE_TIME);
        // return ZonedDateTime.parse("2015-06-18T23:07:25.000", DateTimeFormatter.ISO_ZONED_DATE_TIME.withZone(ZoneId.of("JST", Map.of("JST", "Asia/Tokyo"))));
    }
    ...
    static ZonedDateTime toPST() {
         ...
         */
        return ZonedDateTime.from(ldt.atZone(ZoneId.of("PST", Map.of("PST", "America/Los_Angeles"))));
    }
    ...
    static ZonedDateTime sameInstantAs() {
         ...
         */
        return ZonedDateTime.from(zdt.withZoneSameInstant(ZoneId.of("PST", Map.of("PST", "America/Los_Angeles"))));
    }
    ...
    static ZonedDateTime sameLocalAs() {
         ...
         */
        return ZonedDateTime.from(zdt.withZoneSameLocal(ZoneId.of("PST", Map.of("PST", "America/Los_Angeles"))));
    }
