...
public class TancSoStudentite {
    ...
    public static Semaphore garderoba1;
    public static Semaphore garderoba2;
    public static Semaphore scena;
    public static Semaphore zenskoSpremno;
    ...
    public void init() {
        ...
        garderoba1 = new Semaphore(10);
        garderoba2 = new Semaphore(10);
        scena = new Semaphore(3);
        zenskoSpremno = new Semaphore(0);
